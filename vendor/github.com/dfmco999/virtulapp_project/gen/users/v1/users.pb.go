...
const file_users_v1_users_proto_rawDesc = "" +
	...
	"\ttenant_id\x18\x03 \x01(\tR\btenantId2N\n" +
	"\fUsersService\x12>\n" +
	"\aGetUser\x12\x18.users.v1.GetUserRequest\x1a\x19.users.v1.GetUserResponseB<Z:github.com/dfmco999/virtulapp_project/gen/users/v1;usersv1b\x06proto3"
...
var file_users_v1_users_proto_depIdxs = []int32{
	...
	1, // 1: users.v1.UsersService.GetUser:output_type -> users.v1.GetUserResponse
